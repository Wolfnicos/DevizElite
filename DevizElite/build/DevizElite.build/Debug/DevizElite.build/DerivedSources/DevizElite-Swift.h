...
#ifndef DEVIZELITE_SWIFT_H
#define DEVIZELITE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DevizElite",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10DevizElite11AppDelegate")
...
@class Document;
@class NSSet;
@interface Client (SWIFT_EXTENSION(DevizElite))
...
@class LineItem;
@interface Document (SWIFT_EXTENSION(DevizElite))
...
@property (nonatomic, strong) NSDecimalNumber * _Nullable discount;
...
@property (nonatomic, copy) NSString * _Nullable siteAddress;
@property (nonatomic, copy) NSString * _Nullable paymentTerms;
@property (nonatomic) int16_t validityDays;
@property (nonatomic) double retentionPercent;
...
@class NSWindow;
@class NSCoder;
SWIFT_CLASS("_TtC10DevizElite24EstimateWindowController")
@interface EstimateWindowController : NSWindowController <NSWindowDelegate>
...
@interface InventoryItem (SWIFT_EXTENSION(DevizElite))
- (void)addLineItemsObject:(LineItem * _Nonnull)value;
- (void)removeLineItemsObject:(LineItem * _Nonnull)value;
- (void)addLineItems:(NSSet * _Nonnull)values;
- (void)removeLineItems:(NSSet * _Nonnull)values;
...
SWIFT_CLASS("_TtC10DevizElite23InvoiceWindowController")
@interface InvoiceWindowController : NSWindowController <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface LineItem (SWIFT_EXTENSION(DevizElite))
@property (nonatomic, copy) NSUUID * _Nullable id;
...
@property (nonatomic, strong) InventoryItem * _Nullable inventoryItem;
@end
...
@interface User (SWIFT_EXTENSION(DevizElite))
- (void)addDocumentsObject:(Document * _Nonnull)value;
- (void)removeDocumentsObject:(Document * _Nonnull)value;
- (void)addDocuments:(NSSet * _Nonnull)values;
- (void)removeDocuments:(NSSet * _Nonnull)values;
...
@property (nonatomic, copy) NSString * _Nullable companyAddress;
@property (nonatomic, copy) NSString * _Nullable taxId;
